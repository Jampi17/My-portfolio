...
const dict = {
  es: {
    ...
    'section.blog.title': 'Notas Técnicas',
    'blog.item1.title': 'Automatización con Odoo y Python',
    'blog.item1.subtitle': 'Cómo reducir tareas manuales con módulos personalizados y flujos inteligentes.',
    'blog.item2.title': 'Backend Escalable para Negocio',
    'blog.item2.subtitle': 'Buenas prácticas para construir APIs limpias, mantenibles y listas para crecer.',
    'section.contact.title': 'Hablemos de tu proyecto',
    'contact.cta': 'Si necesitas una solución real para tu negocio, puedo ayudarte con estrategia, desarrollo e implementación.',
    'contact.email': 'Enviar Email',
    'contact.whatsapp': 'Escribir por WhatsApp',
    'contact.web': 'Ver Misti Code',
  ...
  en: {
    ...
    'section.blog.title': 'Technical Notes',
    'blog.item1.title': 'Automation with Odoo and Python',
    'blog.item1.subtitle': 'How to reduce manual work using custom modules and smart workflows.',
    'blog.item2.title': 'Scalable Business Backend',
    'blog.item2.subtitle': 'Practical patterns to build clean, maintainable APIs ready to grow.',
    'section.contact.title': 'Let\'s talk about your project',
    'contact.cta': 'If you need a real solution for your business, I can help with strategy, development and implementation.',
    'contact.email': 'Send Email',
    'contact.whatsapp': 'Chat on WhatsApp',
    'contact.web': 'Open Misti Code',
